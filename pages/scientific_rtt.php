                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="header-text">
                            <div class="header">
                                <img src="../assets/images/includes/scientific_header.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="context_right">
                            <p class="one"><span class="highlighted-text">Neuroplasticity</span> refers to
                                ...
                                directly with the <span class="highlighted-text"></span>subconscious mind, where up to
                                <span class="highlighted-text">95% of our thoughts, behaviours, and
                                    beliefs</span> are stored. RTT's foundation in reprogramming the subconscious mind
                                links to
                                ...
                                well-known factor that drives <span class="highlighted-text">Neuroplasticity.</span> In
                                ...
                                pain, and anxiety. <span class="highlighted-text">Research of The International Journal
                                    of Clinical and Experimental
                                    Hypnosis</span> has shown that hypnotic states can lead to changes in brain
                                activity,
                                ...
                                prefrontal cortex and hippocampus. Research published in <span
                                    class="highlighted-text">Journal of Biological
                                    Psychiatry, Cognitive Neuroscience and Neuroimaging</span> supports the idea that
                                CBT enhances
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="context_left">
                            <img src="../assets/images/includes/scientific_subheader.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="context_middle">
                            <p class="one"> Some studies suggest that language and mental reprogramming techniques used
                                in NLP (and
                                ...
                                circuits that shape their behaviour and responses. Some studies in <span
                                    class="highlighted-text">Cognitive Psychology
                                    and Behavioural Science</span> that language-based interventions could impact brain
                                plasticity
