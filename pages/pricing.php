            ...
            <div class="rtt">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="rttheader">
                                <img src="../assets/images/includes/pricingrtt.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="rtt1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="brainheader">
                                <img src="../assets/images/includes/pricingbrain.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="brain1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="financeheader">
                                <img src="../assets/images/includes/pricingfinance.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="finance1">
