                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="header-text">
                            <div class="header">
                                <img src="../assets/images/includes/carreer_head.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="subheader">
                            <img src="../assets/images/includes/carreer_image.png" alt="">
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="text">
                            <img src="../assets/images/includes/carreer_text.png" alt="">
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="context">
                            <p class="one">RTT (Rapid Transformational Therapy) is a highly effective therapeutic
                            ...
                            <div class="col-lg-12">
                                <div class="subfooter">
                                    <img src="../assets/images/includes/carreer_subhead.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
