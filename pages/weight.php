                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="header-text">
                            <div class="header">
                                <img src="../assets/images/includes/weight_head.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="subheader">
                            <img src="../assets/images/includes/weight_image.png" alt="">
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="text">
                            <img src="../assets/images/includes/weight_text.png" alt="">
                        </div>
                    </div>

                    <div class="col-lg-12">
                        <div class="context">
                            <p class="one"><span class="highlighted-text">Bulimia,</span>, as well as other
                                eating and weight-related issues, can deeply affect both <span
                                    class="highlighted-text">WOMEN</span> and <span
                                    class="highlighted-text">STUDENTS,</span> with
                                ...
                                societal, and biological factors.<br><br>

                                <span class="highlighted-text">Women</span> are often disproportionately affected by
                                ...
                                unhealthy dieting behaviours.<br><br>

                                <span class="highlighted-text">Students,</span> especially teenagers and young adults,
                                ...
                                dissatisfaction and can lead to disordered eating patterns.<br><br>
                                ...
                                to perform academically or socially.<br><br>

                                <span class="highlighted-text">Dieting</span> is a common starting point for many who
                                ...
                                may exercise to the point of injury or exhaustion.<br><br>

                                <span class="highlighted-text">Rapid Transformational Therapy (RTT)</span> is a
                                ...
                                bulimia may have deep-seated beliefs about not being <span
                                    class="highlighted-text">"good enough"</span> or <span
                                    class="highlighted-text">"deserving of
                                    love"</span> unless they conform to a certain body standard. RTT can help replace
                                these
                                negative beliefs with positive, empowering thoughts.<br><br>
                                ...
                                lead to bulimia through by hypnotherapy.<br><br>

                                One of the key benefits of <span class="highlighted-text">Rapid Transformational
                                    Therapy</span> is that it helps individuals
                                ...
                                psychological, and personal factors. For <span class="highlighted-text">WOMEN</span> and
                                <span class="highlighted-text">STUDENTS,</span> who are especially
                                ...
                                developing healthier relationships with food, their bodies, and themselves.<br><br>
                            </p>
                            ...
                            <p class="two">“Recovery from bulimia and other eating disorders is a powerful journey of
                                ...
                                on a scale or how you look, but by who you are on the inside, the kindness you show to
                                others, the strength you embody, and the beauty of your spirit. Healing takes time, but
                                every small step forward is a victory. You have the power to embrace your true self, to
                                heal deeply, and to live a life filled with peace, balance, and love. You are worthy of
                                all the good things that life has to offer, and you deserve to feel at home in your own
                                body. You are worthy of love, especially from yourself.”
                            </p>
